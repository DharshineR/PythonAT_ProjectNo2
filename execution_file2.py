...
from dharshine_guvi_project2.elements_page import AdminPage
...
class AdminTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        pim.click_pim()
        pim.click_add()
        pim.enter_first_name("Dharshine")
        pim.enter_last_name("Ravi")
        pim.click_save()
    ...
    def test_personal_details(self):
        ...
        pim.enter_date_of_birth("1996-11-20")
        #pim.select_gender()
    ...
    def test_contact_details(self):
        ...
        pim.enter_work_email("dharshinir@gmail.com")
    ...
    def test_emergency_contacts(self):
        ...
        pim.enter_emergency_contact_name("Harikrishnan")
        pim.enter_emergency_contact_relation("Husband")
    ...
    def test_dependents(self):
        ...
        pim.enter_dependent_name('Harikrishnan')
        pim.select_dependents_relationship('Husband')
        pim.enter_dependents_dob('1990-05-12')
