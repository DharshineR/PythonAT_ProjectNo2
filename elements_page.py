...
class AdminPage:
    ...
    def enter_new_username(self):
        ...
        self.driver.find_element(By.XPATH, self.new_username_xpath).send_keys('PuviHari')
        ...
        if msg == expected_msg:
            ...
            self.driver.find_element(By.XPATH, self.new_username_xpath).send_keys('Dharsh2011')

    def enter_new_password(self):
        self.driver.find_element(By.XPATH, self.new_password_xpath).click()
        self.driver.find_element(By.XPATH, self.new_password_xpath).send_keys('Dharsh20@')

    def enter_confirm_password(self):
        self.driver.find_element(By.XPATH, self.confirm_password_xpath).click()
        self.driver.find_element(By.XPATH, self.confirm_password_xpath).send_keys('Dharsh20@')
